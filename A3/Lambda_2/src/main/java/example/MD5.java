...
import static example.Hashing.generateMD5;
import static example.Response.executePostRequest;

public class MD5 implements RequestHandler<Map<String, String>, Map<String, String>> {
    ...
    public Map<String, String> handleRequest(Map<String, String> input, Context context) {
        ...
        String hashedValue = generateMD5(value);

        Map<String, String> output = new HashMap<>();
        output.put("banner", "B00984406");
        output.put("result", hashedValue);
        output.put("arn", "arn:aws:lambda:us-east-1:297323627892:function:MD5");
